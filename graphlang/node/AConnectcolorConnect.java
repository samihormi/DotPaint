...
public final class AConnectcolorConnect extends PConnect
{
    private PConnectcolor _connectcolor_;

    public AConnectcolorConnect()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AConnectcolorConnect(
            cloneNode(this._connectcolor_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAConnectcolorConnect(this);
    }
