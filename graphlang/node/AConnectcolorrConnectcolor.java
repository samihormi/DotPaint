...
public final class AConnectcolorrConnectcolor extends PConnectcolor
{
    private TKeywordconnect _keywordconnect_;
    private TColor _color_;
    private TShape _shape_;

    public AConnectcolorrConnectcolor()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AConnectcolorrConnectcolor(
    ...
    {
        ((Analysis) sw).caseAConnectcolorrConnectcolor(this);
    }
