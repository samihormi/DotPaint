...
public final class AConnectcolor2Connectcolor extends PConnectcolor
{
    private TKeywordconnect _keywordconnect_;
    private TColor _color_;
    private TShape _shape_;

    public AConnectcolor2Connectcolor()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AConnectcolor2Connectcolor(
    ...
    {
        ((Analysis) sw).caseAConnectcolor2Connectcolor(this);
    }
