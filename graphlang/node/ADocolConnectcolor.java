...
public final class ADocolConnectcolor extends PConnectcolor
{
    private TKeywordconnect _keywordconnect_;
    private TShape _shape_;

    public ADocolConnectcolor()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseADocolConnectcolor(this);
    }
