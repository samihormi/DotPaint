...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTKeywordsquare(@SuppressWarnings("unused") TKeywordsquare node)
    {
        this.index = 6;
    }

    @Override
    public void caseTKeywordtriangle(@SuppressWarnings("unused") TKeywordtriangle node)
    {
        this.index = 7;
    }

    @Override
    public void caseTKeywordrectangle(@SuppressWarnings("unused") TKeywordrectangle node)
    {
        this.index = 8;
    }

    @Override
    public void caseTKeywordrhombus(@SuppressWarnings("unused") TKeywordrhombus node)
    {
        this.index = 9;
    }
    ...
    @Override
    public void caseTTritype(@SuppressWarnings("unused") TTritype node)
    {
        this.index = 15;
    }
